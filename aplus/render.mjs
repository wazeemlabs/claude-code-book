...
import fs from 'fs';
const boards = {
  Header:[970,600,'01-header-970x600'], Overlay:[970,300,'03-overlay-970x300'],
  ...
  Cards:[300,400,'04-sidebar-cards-300x400'], SidebarCode:[350,175,'04b-sidebar-code-350x175'], CoverClaude:[150,300,'05a-cover-claude-code-150x300'],
  CoverLLM:[150,300,'05b-cover-llm-150x300'],
};
