...
- logsift/, logsift-nginx/: Chapter 8 project and plugin (own git repos)
- brownfield/: Chapter 23, django-helpdesk at 73b19cd4 (own clone;
  branches migration-baseline, migration-integration, migrate/unit-N)
